    ...
    QToolButton(parent)
{
    ...
    setDefaultAction(KiwixApp::instance()->getAction(
        KiwixApp::Actions::ToggleAddBookmarkAction));
}
...
SearchBar::SearchBar(QWidget *parent) :
    ...
    m_searchIconLabel(this),
    m_bookmarkButton(this)
{
    m_searchIconLabel.setObjectName("searchIcon");
    m_searchIconLabel.setPixmap(QIcon(":/icons/search.svg").pixmap(QSize(27, 27)));

    addWidget(&m_searchIconLabel);
